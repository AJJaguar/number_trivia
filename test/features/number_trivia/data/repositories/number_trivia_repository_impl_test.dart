...
import 'package:number_trivia/features/number_trivia/data/datasources/number_trivia_local_data_source%20copy.dart';
...
void main() {
  ...
  group('getConcreteNumberTrivia', () {
    ...
    runTestsOnline(() {
      test(
        'should return remote data when call for remote data is successful',
        () async {
          // arrange
      ...
      test(
        'should cache the data remotely when call to remote data source is successful',
        () async {
          // arrange
          when(mockRemoteDataSource.getConcreteNumberTrivia(any))
              .thenAnswer((_) async => tNumberTriviaModel);
